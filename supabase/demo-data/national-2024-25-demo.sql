...
begin
  ...
  values
    ...
    (v_season_id, 'national', null, v_first_division_id, 8,  ('2024-09-27 16:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 2,  ('2024-10-04 13:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 9,  ('2024-10-04 16:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 3,  ('2024-10-11 13:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 10, ('2024-10-11 16:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 4,  ('2024-10-18 13:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 11, ('2024-10-18 16:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 5,  ('2024-11-08 13:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 12, ('2024-11-08 16:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 6,  ('2024-11-22 13:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 13, ('2024-11-22 16:00'::timestamp at time zone 'Europe/Brussels')),
    (v_season_id, 'national', null, v_first_division_id, 7,  ('2024-11-29 13:00'::timestamp at time zone 'Europe/Brussels')),
  ...
  values
    ('Honor Division', 'Riviera 1'),
    ('Honor Division', 'BBC 3'),
    ('Honor Division', 'BBC 1'),
    ('Honor Division', 'BBC 2'),
    ('Honor Division', 'UAE 1'),
    ('Honor Division', 'BBC 4'),
    ('Honor Division', 'Cercle-Perron 1'),
    ('Honor Division', 'Pieterman 1'),
    ('1st Division', 'Riviera 2'),
    ('1st Division', 'Sandeman 1'),
    ('1st Division', 'Riviera 3'),
    ('1st Division', 'Cercle-Perron 2'),
    ('1st Division', 'Squeeze 1'),
    ('1st Division', 'BBC 5'),
    ('1st Division', 'UAE 2'),
    ('1st Division', 'Genk 1'),
    ('2nd Division A', 'Pieterman 2'),
    ('2nd Division A', 'Cercle-Perron 3'),
    ('2nd Division A', 'Waregem 1'),
    ('2nd Division A', 'Charleroi 1'),
    ('2nd Division A', 'Riviera 4'),
    ('2nd Division A', 'Forum 1'),
    ('2nd Division A', 'Squeeze 2'),
    ('2nd Division A', 'Westrand 1'),
    ('2nd Division B', 'Boeckenberg 1'),
    ('2nd Division B', 'Cercle-Perron 4'),
    ('2nd Division B', 'Cercle-Perron 5'),
    ('2nd Division B', 'Lier 1'),
    ('2nd Division B', 'DUA 1'),
    ('2nd Division B', 'Geel 1'),
    ('2nd Division B', 'Riviera 5'),
    ('2nd Division B', 'Verviers 1'),
    ('3rd Division A', 'Knokke 1'),
    ('3rd Division A', 'Witte Beer 2'),
    ('3rd Division A', 'Forum 2'),
    ('3rd Division A', 'Waasmunster 1'),
    ('3rd Division A', 'Witte Beer 1'),
    ('3rd Division A', 'Bridgeclub Roeselare 1'),
    ('3rd Division A', 'Eeklo 1'),
    ('3rd Division A', 'Westrand 2'),
    ('3rd Division B', 'Argayon 1'),
    ('3rd Division B', 'Sandeman 2'),
    ('3rd Division B', 'Pieterman 3'),
    ('3rd Division B', 'Namur 2'),
    ('3rd Division B', 'UAE 3'),
    ('3rd Division B', 'Wilg & Donk 1'),
    ('3rd Division B', 'Riviera 6'),
    ('3rd Division B', 'BBC 8'),
    ('3rd Division C', 'Namur 1'),
    ('3rd Division C', 'BBC 6'),
    ('3rd Division C', 'Cercle-Perron 6'),
    ('3rd Division C', 'Charleroi 2'),
    ('3rd Division C', 'Cercle-Perron 7'),
    ('3rd Division C', 'B.C. Mons 1'),
    ('3rd Division C', 'Smohain 1'),
    ('3rd Division C', 'BBC 9'),
    ('3rd Division D', 'BBC 7'),
    ('3rd Division D', 'Lier 2'),
    ('3rd Division D', 'Pieterman 4'),
    ('3rd Division D', 'Cercle-Perron 8'),
    ('3rd Division D', 'Zennebridge 1'),
    ('3rd Division D', 'Aarschot 1'),
    ('3rd Division D', 'Retiese 1'),
    ('3rd Division D', 'Riviera 7');
